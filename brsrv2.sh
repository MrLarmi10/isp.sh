...
echo "=== Настройка Ansible только для BR-SRV ==="
...
[brsrv]
BR-SRV ansible_host=127.0.0.1 ansible_user=root ansible_password=P@ssword ansible_port=2026 ansible_ssh_common_args='-o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null'
EOF
